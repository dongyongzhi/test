package com.svein.test.repository;

import com.svein.test.TestApp;

import com.svein.test.config.Constants;
import com.svein.test.config.audit.AuditEventConverter;
import com.svein.test.domain.PersistentAuditEvent;
...
import static com.svein.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
